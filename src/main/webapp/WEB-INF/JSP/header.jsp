    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        <li class="nav-item">
          ...
          href="${pageContext.request.contextPath}?cmd=accueil">Accueil</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active text-light" href="${pageContext.request.contextPath}?cmd=accueil">liste</a>
        </li>
        <li class="nav-item">
      ...
      <div class="text-end">
        ...
        <c:if test="${!empty sessionScope.admin}">
          <a type="button" href="?cmd=logout" class="btn btn-outline-light me-2">logout</a>
        </c:if>
       </div>
    </div>
  </div>
